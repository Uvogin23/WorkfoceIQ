                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                const SizedBox(
                                    width: 30), // Add spacing between fields
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(
                                    width: 30), // space between the two fields
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller: weaponNumberController,
                                          validator: (value) => value!.isEmpty
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: DropdownButtonFormField<String>(
                                          ...
                                          decoration: const InputDecoration(
                                            hintText: 'Selectioner le bureau',
                                            hintStyle: TextStyle(
                                                color: Colors.grey,
                                                fontSize: 14),
                                            border: InputBorder.none,
                                ...
                                ElevatedButton.icon(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: const Color.fromARGB(
                                        ...
                                        209,
                                        189,
                                        35), // optional: different color for reset
                                  ),
                                  onPressed: () {
                                    setState(() {
